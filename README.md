...
| **`seekBackwardTime`**       | <code>number</code>  | Time to seek backward on the OS's notification. Only has affect when `showSeekBackward = true`.                                                                                                                                                                                                                                                                                                                                                                                                          | <code>true</code>  | 2.3.0 |
| **`seekForwardTime`**        | <code>number</code>  | Time to seek forward on the OS's notification. Only has affect when `showSeekForward = true`.                                                                                                                                                                                                                                                                                                                                                                                                            | <code>true</code>  | 2.3.0 |
